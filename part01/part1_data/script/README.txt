...
First we use
 ...
 to generate the all_word_map.pkl and all_word_map.txt. 
The relationship between word and word index is stored in them. 
This step filters out marks and some frequent words.
...
to generate ham_test and spam_test which contains the ditribution of all the words in test with respect to every email. 
Since it is a huge sparse matrix, the format of the output file is different. 
For every line is
